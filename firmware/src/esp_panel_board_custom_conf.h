 ...
 */
 ...
 #define ESP_PANEL_BOARD_HEIGHT              (280)   // Panel height (vertical, in pixels)
  ...
  */
     ...
     /* For host */
     #define ESP_PANEL_BOARD_LCD_SPI_IO_SCK          (17)
     #define ESP_PANEL_BOARD_LCD_SPI_IO_MOSI         (16)
     #define ESP_PANEL_BOARD_LCD_SPI_IO_MISO         (-1)    // -1 if not used
 #endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
     /* For panel */
     #define ESP_PANEL_BOARD_LCD_SPI_IO_CS           (18)     // -1 if not used
     #define ESP_PANEL_BOARD_LCD_SPI_IO_DC           (19)
 ...
 */
 ...
 #define ESP_PANEL_BOARD_LCD_GAP_Y               (20)     // [0, ESP_PANEL_BOARD_HEIGHT]
 
 /**
  * @brief LCD reset pin configuration
  */
 #define ESP_PANEL_BOARD_LCD_RST_IO              (20)    // Reset pin, -1 if not used
  ...
  */
 #define ESP_PANEL_BOARD_TOUCH_RST_IO            (35)    // Reset pin, -1 if not used
